...
export default function Quiz() {
    ...
    const handleSubmit = () => {
        fetch("/calculate_score_mitigation", {
            method: "POST",
            headers: {
    ...
    return (
        <div className="App">
            <div className="allCardsAk">
                <h1 data-testid="titleQuiz" className="titleQuiz">Teste tes connaissances pour aider à protéger l'environnement</h1>
            ...
            <div className="boxRight">
                ...
                <div className="linkOtherQuiz">
                    <a className="textLink" href={"/"}>Passe un autre quiz pour tester tes connaissances sur l'environnement</a>
                </div>
            </div>
        </div>
    );
